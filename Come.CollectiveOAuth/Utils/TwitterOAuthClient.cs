...
{
    public class TwitterOAuthClient : TwitterBase
    {
        public enum Method { GET, POST, DELETE };
        public static string REQUEST_TOKEN = "http://twitter.com/oauth/request_token";
        public static string AUTHORIZE = "http://twitter.com/oauth/authorize";
        public static string ACCESS_TOKEN = "http://twitter.com/oauth/access_token";
        ...
        public TwitterOAuthClient(string ConsumerKey, string ConsumerSecret, string CallBackUrl)
        {
